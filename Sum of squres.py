...
# The Sum Squares function, also referred to as the Axis Parallel Hyper-Ellipsoid function, has no
# local minimum except the global one. It is continuous, convex and uni-model.
def func1(x):
    total = 0
